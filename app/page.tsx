...
const steps = [
  ["01", "Диагностика", "Разбираем текущую систему продаж, воронку, CRM, команду и ограничения роста."],
  ["02", "Архитектура", "Проектируем структуру отдела, роли, KPI, отчётность, скрипты и стандарты."],
  ["03", "Внедрение", "Настраиваем процессы, обучаем команду и внедряем регулярное управление."],
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#002B12] text-white">
        ...
        <div className="relative mx-auto max-w-7xl">
          <header className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-serif text-xl leading-none">MB Consulting</p>
                <p className="text-xs text-white/60">отделы продаж под ключ</p>
              </div>
            </div>
          ...
          <div className="grid gap-12 py-20 md:grid-cols-[1.15fr_0.85fr] md:items-center lg:py-28">
            ...
            >
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-white/72">
                Выстраиваем отдел продаж, CRM, аналитику, скрипты, мотивацию и управление командой — чтобы бизнес рос не за счёт хаоса и ручного контроля, а за счёт системы.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                ...
                >
                  Получить диагностику <ArrowRight size={18} />
                </a>
            ...
            >
              <div className="rounded-[1.5rem] bg-[#001A0B] p-7">
                ...
                <div className="mt-8 grid gap-5">
                  <Metric label="Рост конверсий" value="18–25%" />
                  <Metric label="Без увеличения рекламы" value="0 ₽" />
                  <Metric label="Формат работы" value="End-to-end" />
                </div>

                <div className="mt-8 rounded-2xl border border-white/10 p-5 text-sm leading-6 text-white/65">
                  Меньше хаоса в продажах. Больше прозрачности, управляемости и прогнозируемого результата.
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid gap-10 md:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {pains.map((pain) => (
                ...
                >
                  <CheckCircle2 className="mb-4 text-[#002B12]" size={22} />
                  {pain}
                </div>
              ))}
            </div>
      ...
      <section id="approach" className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-3">
            {services.map((service, i) => {
              const icons = [BarChart3, Users, ShieldCheck, LineChart, Zap, CheckCircle2];
              const Icon = icons[i];
              ...
              return (
                ...
                >
                  ...
                  <p className="text-lg leading-7 text-white/82">{service}</p>
                </div>
              );
            })}
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-4">
            {steps.map(([num, title, text]) => (
              ...
              >
                <p className="font-serif text-5xl text-[#002B12]/20">{num}</p>
                <h3 className="mt-8 text-xl font-semibold">{title}</h3>
                <p className="mt-4 leading-7 text-[#062313]/65">{text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="lead" className="px-6 py-20 md:px-12 lg:px-20">
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[0.9fr_1.1fr] md:items-start">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-white/68">
              На встрече определим ограничения в продажах, приоритеты внедрения и план действий с понятными показателями.
            </p>
          </div>
